<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  ...
  <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a data-bs-toggle="collapse" href="#applicationsExamples" class="nav-link {{Route::is('konten*') ? 'active' : ''}}" aria-controls="applicationsExamples" role="button" aria-expanded="false">
        ...
        <div class="collapse   {{Route::is('konten*') ? 'show' : ''}}" id="applicationsExamples">
